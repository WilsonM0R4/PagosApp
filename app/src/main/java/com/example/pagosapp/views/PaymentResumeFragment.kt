 ...
 * Use the [PaymentResumeFragment.newInstance] factory method to
...
class PaymentResumeFragment : Fragment() {
    ...
    private var _binding : FragmentPaymentResumeBinding? = null
    ...
    companion object {
         ...
         * @return A new instance of fragment PaymentResumeFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PaymentResumeFragment().apply {
